...
*☯︎ ᴇxᴘ:* ${user.exp}
*☯︎ ʟᴇᴠᴇʟ:* ${user.level}
*☯︎ ᴋᴜʟᴛɪᴠᴀsɪ:* ${user.role}
*☯︎ ʜᴇᴀʟᴛʜ:* ${user.health}
*☯︎ ʟɪᴍɪᴛ:* ${user.limit}
*☯︎ ᴍᴏɴᴇʏ:* ${user.money}${user.atm ? `
*☯︎ ᴀᴛᴍ:* ʟᴠ.${user.atm}
*☯︎ ʙᴀɴᴋ:* ${user.bank} $ / ${user.fullatm} $`: ''}
☯︎ *sᴛᴀᴛᴜs:* ${user.premiumTime > 0 ? 'Premium' : 'Free'}
☯︎ *ʀᴇɢɪsᴛᴇʀᴇᴅ:* ${user.registered ? 'Yes':'No'}${user.premiumTime >= 1 ? `
☯︎ *ᴇxᴘɪʀᴇᴅ:*
